...
/**
 * Testes funcionais do sistema PDV Hermes Comercial
 * Simula fluxos completos de negócio como um usuário real utilizaria
 */
@ExtendWith(MockitoExtension.class)
class PDVFuncionalTest {
    ...
    void testFluxoMultiplasVendasConsolidacao() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (Produto produto : produtos) {
                if (i % 2 == 0) { // Simular padrão de vendas
                    ItemVenda item = new ItemVenda();
                    item.setProdutoDescricao(produto.getNome());
                    ...
                    // Simplificado - não usar adicionarItem
                }
            }
